...
// the problem is the dice settled anyway but when we use promise the result will be resolve or reject so if it will resolve
// it will settle while it wont settle if rejected
