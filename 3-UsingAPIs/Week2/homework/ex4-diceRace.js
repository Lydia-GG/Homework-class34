...
function rollTheDices() {
  ...
  const allDices = dices.map((dice) => rollDice(dice));
  return Promise.race(allDices);
}
...
/*the array of promises will run anyway while promise race will give us the result of the faster or first ( resolved of rejected) promise */
